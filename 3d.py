...
try:
    ...
    print("Script Error: Wrong arguments")
    ...
    try:
        ...
        if action == "interpret":
            ...
            try:
                ...
                print(character + " is not a valid hex number")
                break
